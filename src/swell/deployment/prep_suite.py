...
def prepare_cylc_suite_jinja2(logger, swell_suite_path, exp_suite_path, experiment_dict):
    ...
    render_dictionary['scheduling']['GenerateBClimatology']['qos'] = 'cas'
    ...
    render_dictionary['scheduling']['GenerateBClimatology']['constraint'] = 'cas'
    ...
    render_dictionary['scheduling']['RunJediHofxExecutable']['qos'] = 'cas'
    ...
    render_dictionary['scheduling']['RunJediHofxExecutable']['constraint'] = 'cas'
    ...
    render_dictionary['scheduling']['RunJediVariationalExecutable']['qos'] = 'cas'
    ...
    render_dictionary['scheduling']['RunJediVariationalExecutable']['constraint'] = 'cas'
    ...
    render_dictionary['scheduling']['RunGeosExecutable']['qos'] = 'cas'
